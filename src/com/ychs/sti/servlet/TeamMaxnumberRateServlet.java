...
/**
 * Servlet implementation class TeamMaxnumberRateServlet
 */
@WebServlet("/TeamMaxnumberRateServlet")
public class TeamMaxnumberRateServlet extends HttpServlet {
     ...
     */
    public TeamMaxnumberRateServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> list = ts.teamMaxnumberRate();
