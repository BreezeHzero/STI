...
/**
 * Servlet implementation class CheckTeaminfoServlet
 */
@WebServlet("/CheckTeaminfoServlet")
public class CheckTeaminfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Team> list = ts.findTeamByIdANDname(competitionid,teamid, teamname);
