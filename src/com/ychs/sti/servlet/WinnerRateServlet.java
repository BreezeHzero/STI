...
/**
 * Servlet implementation class WinnerRateServlet
 */
@WebServlet("/WinnerRateServlet")
public class WinnerRateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> list = ts.winnerRate();
